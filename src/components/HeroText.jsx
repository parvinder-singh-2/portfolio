  ...
  return (
    <div className='z-10 mt-20 text-center md:mt-40 md:text-left rounded-3xl bg-clip-text'>
        ...
        <div className="flex flex-col space-y-6 md:hidden">
            ...
            animate="visible"
            transition={{ delay: 1 }}
            className="text-4xl font-medium">Hi I'm Parvinder</motion.p>
            <div className="">
                <motion.p 
                variants={varients}
                initial="hidden"
                ...
                animate="visible"
                transition={{ delay: 1.8 }}
                className="text-4xl font-black text-neutral-300">Web Applications</motion.div>
            </div>
        </div>
    </div>
  )
